...
RAND_DATA_GEN_KAFKA_PRODUCER_TOPIC_CONF_SUBPATH = 'kafka_producer_topic.yml'
RAND_DATA_GEN_KAFKA_PRODUCER_MSG_SERIAL_CONF_SUBPATH = 'kafka_producer_msg_serialisation.yml'
RAND_DATA_GEN_KAFKA_PRODUCER_SCHEMA_REGISTRY_CONN_CONF_SUBPATH = 'kafka_producer_schema_registry_conn.yml'
