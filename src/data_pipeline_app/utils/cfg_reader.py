...
if __name__ == '__main__':
    ...
    jinja_templated_yml_cfg = yml_cfg_reader.read_jinja_templated_cfg(file_path='cfg/data_pipeline_app/01_ingestion/spark_app.yml', cfg_vars={'postgres': '/root/postgres_jar', 'postgre': '/root/postgres_jar'})
